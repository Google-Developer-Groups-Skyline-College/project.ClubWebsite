...
export const ANNOUNCEMENT_TEXT: string = '🚀 Our Third Intercollegiate Hackathon is coming April 17! Applications are open now!' // Announcement bar will be hidden if empty string
...
export const INFOHUB_MEETING_HOUR: string = '14:15' // Uses 24-hour time format, i.e "12:34"
