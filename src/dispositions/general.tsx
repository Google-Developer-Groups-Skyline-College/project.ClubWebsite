...
export const ANNOUNCEMENT_TEXT: string = '🚀 Hey, Explorers! The SMCCCD Intercollegiate Hackathon is BACK! Apply now at https://skycs.club/hackathon!' 
// Background gradient. keep the 'from-' prefix and have the color code within the square [] brackets
export const ANNOUNCEMENT_GRAD_COLOR: string = 'from-[#9B0074FF]'
