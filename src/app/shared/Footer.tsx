        ...
        <footer className='w-full bg-gradient-to-b from-neutral-800 dark:from-neutral-950 to-neutral-950 dark:to-black text-lg font-semibold pt-4 text-center'>
            ...
            <div className='flex flex-row flex-wrap gap-3 justify-center py-4'>
                <Link
                    ...
                    target='_blank'
                >
                    <div className='flex group w-[120px] sm:w-[134px] sm:hover:w-[140px] justify-center bg-neutral-700 dark:bg-neutral-900 bg-opacity-80 rounded-md gap-2 py-2 2 active:scale-95 hover:bg-blue-800 hover:outline-4 hover:text-white text-lg font-semibold active:outline-2 hover:outline-double outline-white border-[1px] border-neutral-800 hover:outline-blue-600 active:outline-neutral-200 duration-200 active:duration-200'>
                ...
                <Link
                    ...
                    target='_blank'
                >
                    <div className='flex group w-[120px] sm:w-[134px] sm:hover:w-[140px] justify-center bg-neutral-700 dark:bg-neutral-900 bg-opacity-80 rounded-md gap-2 py-2 2 active:scale-95 hover:bg-red-900 hover:outline-4 hover:text-white text-lg font-semibold active:outline-2 hover:outline-double outline-white border-[1px] border-neutral-800 hover:outline-red-700 active:outline-neutral-200 duration-200 active:duration-200'>
                ...
                <Link
                    ...
                    target='_blank'
                >
                    <div className='flex group w-[120px] sm:w-[134px] sm:hover:w-[140px] justify-center bg-neutral-700 dark:bg-neutral-900 bg-opacity-80 rounded-md gap-2 py-2 2 active:scale-95 hover:bg-blue-600 hover:outline-4 hover:text-white text-lg font-semibold active:outline-2 hover:outline-double outline-white border-[1px] border-neutral-800 hover:outline-blue-400 active:outline-neutral-200 duration-200 active:duration-200'>
                ...
                <Link
                    ...
                    target='_blank'
                >
                    <div className='flex group w-[120px] sm:w-[134px] sm:hover:w-[140px] justify-center bg-neutral-700 dark:bg-neutral-900 bg-opacity-80 rounded-md gap-2 py-2 2 active:scale-95 hover:bg-purple-600 hover:outline-4 hover:text-white text-lg font-semibold active:outline-2 hover:outline-double outline-white border-[1px] border-neutral-800 hover:outline-purple-400 active:outline-neutral-200 duration-200 active:duration-200'>
                ...
                <Link
                    ...
                    target='_blank'
                >
                    <div className='flex group w-[120px] sm:w-[134px] sm:hover:w-[140px] justify-center bg-neutral-700 dark:bg-neutral-900 bg-opacity-80 rounded-md gap-1 py-2 2 active:scale-95 hover:bg-yellow-700 hover:outline-4 hover:text-white text-lg font-semibold active:outline-2 hover:outline-double outline-white border-[1px] border-neutral-800 hover:outline-yellow-700 active:outline-neutral-200 duration-200 active:duration-200'>
                ...
                <Link href='https://linktr.ee/skylinecsc' target='_blank'>
                    <div className='flex group w-[120px] sm:w-[134px] sm:hover:w-[140px] justify-center bg-neutral-700 dark:bg-neutral-900 bg-opacity-80 rounded-md gap-2 py-2 2 active:scale-95 hover:bg-green-900 hover:outline-4 hover:text-white text-lg font-semibold active:outline-2 hover:outline-double outline-white border-[1px] border-neutral-800 hover:outline-green-700 active:outline-neutral-200 duration-200 active:duration-200'>
